...
///
/// (-- They MUST match the canonical error space for google3 APIs
///     found at google3/util/task/codes.proto and absl::StatusCode found at
///     google3/third_party/absl/status/status.h.
///
/// Warnings:
///
...
public enum Google_Rpc_Code: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Google_Rpc_Code] = [
    .ok,
    .cancelled,
    .unknown,
    .invalidArgument,
