...
/// token.
///
/// Usage: instantiate `Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClient`, then call
...
public protocol Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientProtocol: GRPCClient {
  ...
  var interceptors: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientInterceptorFactoryProtocol? {
    get
  }

  func executeQuery(_ request: Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
                    callOptions: CallOptions?)
    -> UnaryCall<Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
      Google_Firebase_Dataconnect_V1alpha_ExecuteQueryResponse>

  func executeMutation(_ request: Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
                       callOptions: CallOptions?)
    -> UnaryCall<Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
      Google_Firebase_Dataconnect_V1alpha_ExecuteMutationResponse>
}

public extension Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientProtocol {
  ...
  func executeQuery(_ request: Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
    ...
    return makeUnaryCall(
      path: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientMetadata.Methods.executeQuery
        .path,
      request: request,
  ...
  func executeMutation(_ request: Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
    ...
    -> UnaryCall<Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
      Google_Firebase_Dataconnect_V1alpha_ExecuteMutationResponse> {
    return makeUnaryCall(
      path: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientMetadata.Methods
...
public final class Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClient: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientProtocol {
  ...
  public init(channel: GRPCChannel,
              ...
              interceptors: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientInterceptorFactoryProtocol? =
                nil) {
...
public struct Google_Firebase_Dataconnect_V1alpha_ConnectorServiceNIOClient: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceClientProtocol {
  ...
  public protocol Google_Firebase_Dataconnect_V1alpha_ConnectorServiceAsyncClientProtocol: GRPCClient {
    ...
    func makeExecuteQueryCall(_ request: Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
                              callOptions: CallOptions?)
      -> GRPCAsyncUnaryCall<Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
        Google_Firebase_Dataconnect_V1alpha_ExecuteQueryResponse>

    func makeExecuteMutationCall(_ request: Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
                                 callOptions: CallOptions?)
      -> GRPCAsyncUnaryCall<Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
        Google_Firebase_Dataconnect_V1alpha_ExecuteMutationResponse>
  }

  @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
  public extension Google_Firebase_Dataconnect_V1alpha_ConnectorServiceAsyncClientProtocol {
...
public protocol Google_Firebase_Dataconnect_V1alpha_ConnectorServiceProvider: CallHandlerProvider {
  var interceptors: Google_Firebase_Dataconnect_V1alpha_ConnectorServiceServerInterceptorFactoryProtocol? {
    get
  }

  /// Execute a predefined query in a Connector.
  func executeQuery(request: Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
                    context: StatusOnlyCallContext)
    -> EventLoopFuture<Google_Firebase_Dataconnect_V1alpha_ExecuteQueryResponse>

  /// Execute a predefined mutation in a Connector.
  func executeMutation(request: Google_Firebase_Dataconnect_V1alpha_ExecuteMutationRequest,
                       context: StatusOnlyCallContext)
    -> EventLoopFuture<Google_Firebase_Dataconnect_V1alpha_ExecuteMutationResponse>
}
...
public extension Google_Firebase_Dataconnect_V1alpha_ConnectorServiceProvider {
  ...
  public protocol Google_Firebase_Dataconnect_V1alpha_ConnectorServiceAsyncProvider: CallHandlerProvider {
    ...
    /// Execute a predefined query in a Connector.
    @Sendable func executeQuery(request: Google_Firebase_Dataconnect_V1alpha_ExecuteQueryRequest,
  ...
  @available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
  public extension Google_Firebase_Dataconnect_V1alpha_ConnectorServiceAsyncProvider {
    static var serviceDescriptor: GRPCServiceDescriptor {
      return Google_Firebase_Dataconnect_V1alpha_ConnectorServiceServerMetadata.serviceDescriptor
    }
    ...
    func handle(method name: Substring,
      ...
      case "ExecuteQuery":
        return GRPCAsyncServerHandler(
          ...
          >(),
          interceptors: interceptors?.makeExecuteQueryInterceptors() ?? [],
          wrapping: executeQuery(request:context:)
        )
      ...
      case "ExecuteMutation":
        return GRPCAsyncServerHandler(
          ...
          >(),
          interceptors: interceptors?.makeExecuteMutationInterceptors() ?? [],
          wrapping: executeMutation(request:context:)
        )
